...
namespace WebAPI.Controllers
{
    ...
    public class CarImagesController : ControllerBase
    {
        ...
        {
            var carImage = _carImageService.GetImageById(carId).Data;
        ...
        [HttpGet("getImagebyıd")]
        public IActionResult GetImageById(int ımageId)
        {
            var result = _carImageService.GetImageById(ımageId);
            if (result.Success)
            {
                return Ok(result);
            }
